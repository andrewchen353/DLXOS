...
#define MEM_PAGESIZE (0x1 << MEM_L2FIELD_FIRST_BITNUM) // 4096
#define MEM_L1TABLE_SIZE ((MEM_MAX_VIRTUAL_ADDRESS + 1) >> (MEM_L1FIELD_FIRST_BITNUM)) // 4 I added the +1
#define MEM_L2TABLE_SIZE 0x1 << (MEM_L1FIELD_FIRST_BITNUM - MEM_L2FIELD_FIRST_BITNUM) // 256
#define MEM_ADDRESS_OFFSET_MASK (MEM_PAGESIZE - 1) // 4095

#define MEM_MAX_PHYS_MEM (0x1 << 21) // 0x200000
